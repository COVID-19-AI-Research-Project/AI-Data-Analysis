...
||
|:--:|
| ![](Media/Images/total_confirmed.png)|
...
||
|:--:|
| ![](Media/Images/total_per_population.png)|
...
Let us deshelve the ignorance and the resultant fear. And try data based rational approach. There are many mathematical models to study infectious diseases. The most used and quite simple is the [SIR](https://web.stanford.edu/~jhj1/teachingdocs/Jones-on-R0.pdf) model. The name arises from the fact that it divides the population into three compartments:
...
||
|:--:|
| ![](Media/Images/china_sir_model.png)|
...
||| |
|:--:| :--:|:--:|
| ![](Media/Images/p20m0p3c.png)|![](Media/Images/p20m0p8c.png)|![](Media/Images/p20m0p1c.png)|
...
- **PROJECT AUTHOR:** [Dr Amita Kapoor](https://www.leukemiaresearchassociation.ai/team/amita-kapoor "Dr Amita Kapoor") - [Peter Moss Leukemia AI Research](https://www.leukemiaresearchassociation.ai "Peter Moss Leukemia AI Research") Student Program Team & R&D, Delhi, India
